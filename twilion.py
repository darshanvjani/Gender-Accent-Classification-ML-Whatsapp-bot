...
def sms_reply():
    ...
    _result, _ = urllib.request.urlretrieve(webpage.url, "huehue.ogg")
    print(_result)
    ...
    # print(ogg_file_name)
    # input_path = "{0}/{1}".format(_path, ogg_file_name)
    
    # print("input" + input_path)
    # wav_file_name = str(file_name+'.wav')
    # output_path = str(_path+'/'+wav_file_name)
    # print(output_path)
    #with open(input_path) as f:
    wav_file_path = "./new.wav"
    ogg_version = AudioSegment.from_ogg(_result)
    ogg_version.export(wav_file_path, format="wav")
